/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9e6b46c14ef82fd35db2492fc134e55e)
// Runtime types generated with workerd@1.20250525.0 2025-04-04 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		VALUE_FROM_CLOUDFLARE: "Hello from Cloudflare";
		ZERO_UPSTREAM_DB: string;
		CHAT_ROOMS: DurableObjectNamespace<import("./workers/app").ChatRoomObject>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VALUE_FROM_CLOUDFLARE" | "ZERO_UPSTREAM_DB">> {}
}
